...
//   DollarSign,
//   Package,
//   Edit, // Añadido Edit para la vista de tabla
//   Trash2, // Añadido Trash2 para la vista de tarjeta/tabla
// } from "lucide-react";
// import { PATHROUTES } from "@/constants/pathroutes";
// import { Card } from "@/components/ui/Card";
// import { Button } from "@/components/ui/Button";
...
//   // 🔹 Funciones para ver detalles, editar / eliminar
//   const handleViewDetails = (id: string) => {
//     router.push(PATHROUTES.pymes.compras_detalle(id));
//   };
//   const handleEdit = (id: string) => {
//     router.push(PATHROUTES.pymes.compras_editar(id));
//   };
...
//                   {/* 🔹 Botones con la estética de tarjetas de clientes */}
//                   <div className="flex gap-2 p-4 pt-0">
//                     <Button
//                       variant="outline"
...
//                     <Button
//                       variant="outline"
//                       className="flex-shrink-0 px-4 h-full" // Mismo estilo de Editar que en clientes
//                       onClick={() => handleEdit(order.id)}
//                     >
//                       Editar
//                     </Button>
//                     <Button
//                       variant="danger"
//                       className="flex-shrink-0 p-2 h-auto" // Botón de eliminar con icono
//                       onClick={() => confirmDelete(order.id)}
//                     >
...
//                         <Link href={PATHROUTES.pymes.compras_detalle(order.id)} onClick={(e) => e.stopPropagation()}>
//                             <Button variant="outline" className="px-3 py-1 text-xs h-auto">
//                               Ver
//                             </Button>
//                           </Link>
//                           {/* Botón Editar (outline, icono) */}
//                           <Link href={PATHROUTES.pymes.compras_editar(order.id)} onClick={(e) => e.stopPropagation()}>
...
//   // 🔹 Funciones para ver detalles, editar / eliminar
//   const handleViewDetails = (id: string) => {
//     // Mantengo esta función por si se quiere añadir un link de detalle más tarde,
//     // pero la quitamos de la UI por ahora.
//     router.push(PATHROUTES.pymes.compras_detalle(id));
//   };
//   const handleEdit = (id: string) => {
//     router.push(PATHROUTES.pymes.compras_editar(id));
...
//                   {/* 🔹 Botones: Editar ocupa el largo restante, Eliminar es icono */}
//                   <div className="flex gap-2 p-4 pt-0">
//                     <Link
...
//                   // Hacemos que toda la tarjeta sea cliqueable para ver detalles, simulando el comportamiento del listado de Clientes/Proveedores
//                   onClick={() => router.push(PATHROUTES.pymes.compras_detalle(order.id))}
//                   isClickable={true} 
//                 >
                  
//                   {/* Contenido de la tarjeta (Estilo Proveedor/Cliente) */}
...
//                   {/* Botones (Editar largo, Eliminar icono) */}
//                   <div className="flex gap-2 p-4 pt-0">
//                     <Link
//                       href={PATHROUTES.pymes.compras_editar(order.id)}
//                       className="flex-grow" // Ocupa todo el espacio disponible
//                       onClick={(e) => e.stopPropagation()} // Evita que el click en el botón active el click de la tarjeta
//                     >
//                       <Button
//                         variant="outline"
//                         className="w-full" // Ocupa el 100% de su contenedor (flex-grow)
...
//                       key={order.id}
//                       className="border-b border-border last:border-b-0 hover:bg-background"
//                       // Hacemos que la fila sea cliqueable para ir a detalles
//                       onClick={() => router.push(PATHROUTES.pymes.compras_detalle(order.id))}
//                       role="button"
//                       tabIndex={0}
//                     >
