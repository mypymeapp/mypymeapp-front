...
// import { Card } from "@/components/ui/Card";
// import { Button } from "@/components/ui/Button";
// import { Phone, Mail, PlusCircle, Loader2, AlertTriangle, Edit, Trash2, LayoutGrid, List, Search, Users } from 'lucide-react';
// import Link from 'next/link';
// import { useRouter } from "next/navigation";
// import { toast } from "react-hot-toast";
// import { PATHROUTES } from '@/constants/pathroutes';
...
//                         {/* Se elimina la sección de Notas */}
                        
//                       </div>
//                       {/* Fin Contenido de la tarjeta */}

//                       {/* Botones de acción (Se elimina el border-t border-border) */}
...
//                       {/* Botones de acción */}
//                       {/* Ahora tiene 3 botones: Ver Detalles (principal), Editar y Eliminar */}
//                       <div className="flex gap-2 mt-auto p-4 border-t border-border"> 
//                         <Link
...
//                         <Button
//                           variant="danger"
//                           className="flex-shrink-0 p-2 h-auto" // Ocupa el espacio mínimo
//                           onClick={(e) => {
//                             e.stopPropagation(); 
//                             confirmDelete(customer.id);
//                           }}
