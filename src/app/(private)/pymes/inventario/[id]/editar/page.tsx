...
// 💡 CAMBIO CLAVE: Eliminamos `params` de los props del componente.
export default function EditarProductoPage() {
    // 💡 CAMBIO CLAVE: Usamos el hook `useParams` para obtener el ID.
    ...
    if (loading) { return <div className="p-8 flex justify-center"> <ListOrdered className="animate-spin h-12 w-12 text-primary" /></div>; }
